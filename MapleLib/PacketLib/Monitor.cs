...
namespace MapleLib.PacketLib
{
    public class Monitor
    {
        ...
        {
            Socket.Bind(new IPEndPoint(pIP, 0));
            Socket.SetSocketOption(SocketOptionLevel.IP, SocketOptionName.HeaderIncluded, true);
            byte[] byIn = {1, 0, 0, 0};
            Socket.IOControl(IOControlCode.ReceiveAll, byIn, null);
        ...
        /// </summary>
        public void WaitForData() => WaitForData(new SocketInfo(Socket, short.MaxValue));
        ...
        private void WaitForData(SocketInfo pSocketInfo)
        {
            try
            {
                Socket.BeginReceive(pSocketInfo.DataBuffer,
                    pSocketInfo.Index,
